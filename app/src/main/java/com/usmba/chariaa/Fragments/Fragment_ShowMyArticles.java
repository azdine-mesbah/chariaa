...
public class Fragment_ShowMyArticles extends DialogFragment implements Interactor {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_show_my_articles, container, false);
        initComponents();
        loadArticles();
        return view;
    }
    ...
    public void initComponents() {
        main_content_Home_articles = view.findViewById(R.id.main_content_Myarticles);
        recyclerView_Articles = view.findViewById(R.id.recyclerview_MyArticles);
        progressBar_Articles = view.findViewById(R.id.progressBar_MyArticles);
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            parameters.put("nins",mainActivity.dataEtudiant.getEtudiant().getNins());//nins is empty to load all articles
